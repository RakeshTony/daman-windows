...
class CollectionPage extends StatelessWidget {
  ...
  CollectionPage(this.operator);

  @override
  Widget build(BuildContext context) {
    return CollectionPageBody(operator);
  }
}

class CollectionPageBody extends StatefulWidget {
  final Operator operator;

  CollectionPageBody(this.operator);

  @override
  State<StatefulWidget> createState() => _CollectionPageBodyState();
}

class _CollectionPageBodyState
    extends BasePageState<CollectionPageBody, ViewModelCollection> {
...
class WidgetNumber extends StatefulWidget {
  ...
  OperatorValidateData? billDetails;
  ...
  OperatorValidateData? getBillDetails() {
    return notifierBill.value;
  }
  ...
  void setBillDetails(OperatorValidateData? billDetails) {
                  ...
                  child: InkWell(
                    onTap: () {
                      if (widget.onTapFetchBill != null) {
                        ...
                        var number =
                            widget.textEditingController.text.toString();
                        if (number.length.isRange(widget.fieldModel.minLength,
                            widget.fieldModel.maxLength)) {
                          widget.onTapFetchBill!(number);
                        } else {
                          AppAction.showGeneralErrorMessage(context,
                              "Please Enter valid ${widget.fieldModel.name}");
                        }
*/
                      }
                    },
