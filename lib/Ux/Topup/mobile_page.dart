...
class MobilePage extends StatelessWidget {
  ...
  MobilePage(this.operator);

  @override
  Widget build(BuildContext context) {
    return MobileBody(operator);
  }
}
...
class MobileBody extends StatefulWidget {
  ...
  MobileBody(this.operator);

  @override
  State<StatefulWidget> createState() => _MobileBodyState();
}

class _MobileBodyState extends BasePageState<MobileBody, ViewModelMobile> {
  ...
  _widgetPlan(UserPlanModel plan) {
    return Container(
      ...
      decoration: BoxDecoration(
        color:
            ((mPlan?.planId ?? "") == plan.planId) ? kWhiteColor : kMainColor,
