...
class ViewModelMobile extends BaseViewModel {
  ...
  final StreamController<Pair<ParamOperatorModel, CurrencyData>>
      _operatorStreamController = StreamController();

  Stream<Pair<ParamOperatorModel, CurrencyData>> get operatorStream =>
    ...
    request(
      ...
      (map) {
        ...
        if (dataModel.paramsModel != null) {
          ...
          _operatorStreamController.sink
              .add(Pair(data.operator, data.currency));
          ...
          if (data.isCustomPlanShow) {
            ...
            data.apiPlans.forEach((element) {
              var plans =
              element.plans.map((e) => UserPlanModel.fromApiPlan(e)).toList();
              apiPlans.add(Pair(element.title, plans));
            });
            /*var plans =
                data.apiPlans.map((e) => UserPlanModel.fromApiPlan(e)).toList();
            apiPlans.add(Pair("All", plans));*/
