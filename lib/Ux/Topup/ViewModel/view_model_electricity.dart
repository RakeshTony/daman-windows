...
class ViewModelElectricity extends BaseViewModel {
  ...
  final StreamController<Pair<Map<String, dynamic>, BulkTopUpResponseDataModel>>
      _responseStreamController = StreamController();

  Stream<Pair<Map<String, dynamic>, BulkTopUpResponseDataModel>>
      get responseStream => _responseStreamController.stream;
  ...
  void requestBulkTopUp({
    ...
    required OperatorValidateData? operatorInfo,
    required String subscriberTitle,
  }) async {
    var min = 100000;
    var max = 999999;
    ...
    Map<String, dynamic> bundle = HashMap();
    bundle["receipt_no"] = requestNumber.toString();
    bundle["operator_info"] = operatorInfo;
    bundle["subscriber_title"] = subscriberTitle;
    request(
      networkRequest.doBulkTopUp(requestMap),
      (map) {
        BulkTopUpResponseDataModel dataModel = BulkTopUpResponseDataModel();
        dataModel.parseData(map);
        _responseStreamController.sink.add(Pair(bundle, dataModel));
      },
      errorType: ErrorType.POPUP,
      requestType: RequestType.NON_INTERACTIVE,
