...
enum FieldStyle { underline, box, oval }
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          counterText: "",
          filled: true,
          fillColor: kOTPBackground,
          enabledBorder: OutlineInputBorder(
            borderSide: const BorderSide(width: 3, color: kOTPBackground),
            borderRadius: BorderRadius.circular(widget.fieldWidth),
          ),
        ...
        onChanged: (String str) {
          ...
          if (!_pin.contains(null) &&
            ...
            if (widget.onCompleted != null) widget.onCompleted!(currentPin);
          }
